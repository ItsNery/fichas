        ...
        dimensionSelect.addEventListener('change', function() {
            ...
            fetch(`${window.APP_URL}/api/dimension/${dimensionId}/anios-disponibles`)
                ...
                .then(anios => {
                    ...
                    // Añadimos la opción de "Todos los años"
                    anioSelect.add(new Option('Todos los años (Histórico)', 'todos'));
        ...
        complejoSelect.addEventListener('change', function() {
            ...
            fetch(`${window.APP_URL}/api/indicador-complejo/${indicadorId}/anios-disponibles`)
                ...
                .then(anios => {
                    ...
                    if (anios.length > 0) {
                        // Añadimos la opción de "Todos los años"
                        complejoAnioSelect.add(new Option('Todos los años (Histórico)', 'todos'));
                    }
